...
exports.rolesList = exports.licenses = exports.questions = exports.assignTo = exports.subCompetencies = exports.categories = exports.competencies = exports.defaultAdminRole = exports.defaultRole = void 0;
exports.defaultRole = [
    {
        id: '9100714781927703',
        parentId: '',
...
exports.questions = [
    ...
    {
        question: 'No matter how hard I work, I believe that I continue to be stuck and dissatisfied where I am.',
        type: 'RANGE',
        rank: 'negative',
        assignTo: { title: 'Adult' },
        subCompetency: { title: 'Optimistic Outlook' },
    ...
    {
        question: "I am at a social gathering that is somewhat crowded. A guest seems to be intoxicated and has walked by my chair twice, shoving me each time. They say, I'm sorry, each time but shove me more forcefully the next time and keep walking. What would you most likely do in this situation?",
        type: 'MULTIPLE',
        rank: 'positive',
        assignTo: { title: 'Adult' },
    ...
    {
        question: 'I am in a team project at work in the midst of the workday. A few of my coworkers who are not on my team but in the same workspace keep showing each other pictures on their phones of their weekend. My team has a deadline coming up. What would you most likely do in this situation?',
        type: 'MULTIPLE',
        rank: 'positive',
        assignTo: { title: 'Adult' },
        subCompetency: { title: 'Internal Regulation' },
    ...
    {
        question: 'The company I work for has laid off several people in my division. As a consequence, I am expected to complete tasks I am not familiar with and I am not paid to do. I am feeling stressed and demoralized. What would you most likely do during this time?',
        type: 'MULTIPLE',
        rank: 'positive',
        assignTo: { title: 'Adult' },
        subCompetency: { title: 'Internal Regulation' },
    ...
    {
        question: 'I actively pursue learning new skills to help myself manage my thoughts and emotions.',
        type: 'RANGE',
        rank: 'positive',
        assignTo: { title: 'Adult' },
        subCompetency: { title: 'Internal Regulation' },
    ...
    {
        question: 'I have acted out of emotion or assumptions before thinking about the consequences of my behavior.',
        type: 'RANGE',
        rank: 'negative',
        assignTo: { title: 'Adult' },
    ...
    {
        question: 'I am feeling anxious about a work deadline.In this situation, what would you most likely do?',
        type: 'RANGE',
        rank: 'positive',
        assignTo: { title: 'Adult' },
        subCompetency: { title: 'Behavior Control' },
    ...
    {
        question: 'I practice constructive habits to manage feelings of anxiety, worry, and stress.',
        type: 'RANGE',
        rank: 'positive',
        assignTo: { title: 'Adult' },
        subCompetency: { title: 'Behavior Control' },
    ...
    {
        question: 'I multi-task to a level that I get distracted and have difficulty finishing what I started.',
        type: 'RANGE',
        rank: 'negative',
        assignTo: { title: 'Adult' },
        subCompetency: { title: 'Behavior Control' },
    ...
    {
        question: 'I find myself working or putting effort into things that do not have a clear purpose.',
        type: 'RANGE',
        rank: 'negative',
        assignTo: { title: 'Adult' },
    ...
    {
        question: 'I encourage others to share their thoughts and feelings to contribute to discussions.',
        type: 'RANGE',
        rank: 'positive',
        assignTo: { title: 'Adult' },
        subCompetency: { title: 'Communication' },
    ...
    {
        question: 'I accept responsibility and the potential consequences of my actions before and after taking action.',
        type: 'RANGE',
        rank: 'positive',
        assignTo: { title: 'Adult' },
        subCompetency: { title: 'Consequence Evaluation' },
    ...
    {
        question: 'I use the consequences of my actions from the past to guide my future decision-making.',
        type: 'RANGE',
        rank: 'positive',
        assignTo: { title: 'Adult' },
        subCompetency: { title: 'Consequence Evaluation' },
    ...
    {
        question: 'My manager has given me a bad evaluation even though I feel like I have put in extra hours and worked really hard this year. I also helped the company improve their sales. My poor evaluation will prevent me from getting a bonus I feel I deserve.  What would you most likely do in this situation?',
        type: 'MULTIPLE',
        rank: 'positive',
        assignTo: { title: 'Adult' },
        subCompetency: { title: 'Initiative' },
    ...
    {
        question: 'I witnessed a coworker being verbally harassed by others because of the color of their skin. The coworker complains to the manager about what is happening to them. The manager does not do anything about it. What would you most likely do in this situation?',
        type: 'MULTIPLE',
        rank: 'positive',
        assignTo: { title: 'Adult' },
        subCompetency: { title: 'Initiative' },
    ...
    {
        question: 'One afternoon, one of my coworkers has an idea to play a prank on one of the new interns. All of the coworkers agree with the plan, and I am asked to do something that I know will embarrass the intern. What would you most likely do in this situation?',
        type: 'MULTIPLE',
        rank: 'positive',
        assignTo: { title: 'Adult' },
    ...
    {
        question: 'I avoid community involvement, professional gatherings, or other social activities even when they can benefit my personal and/ or career growth.',
        type: 'RANGE',
        rank: 'negative',
        assignTo: { title: 'Adult' },
        subCompetency: { title: 'Social Engagement' },
    ...
    {
        question: 'My new neighbor moved in next door, and I noticed that they use a wheelchair. However, I also noticed that their home does not have a ramp by the front door. One day as I am taking the groceries out of my car, I notice them struggling to get in the doorway. What would you most likely do in this situation?',
        type: 'MULTIPLE',
        rank: 'positive',
        assignTo: { title: 'Adult' },
    ...
    {
        question: 'There is a new coworker at my workplace. Each morning they have been walking into the office looking upset and sitting by themself in the company cafeteria. What would you most likely do in this situation?',
        type: 'MULTIPLE',
        rank: 'positive',
        assignTo: { title: 'Adult' },
        subCompetency: { title: 'Appreciating Social & Environmental Diversity' },
    ...
    {
        question: "I am invited to my co-worker's home for a potluck. I am especially picky with my food, but I noticed there are a lot of foods I cannot recognize, especially the dishes that were brought by my coworker. What would you most likely do in this situation?",
        type: 'MULTIPLE',
        rank: 'positive',
        assignTo: { title: 'Adult' },
        subCompetency: { title: 'Appreciating Social & Environmental Diversity' },
    ...
    {
        question: "I am on a crowded train after work. Some people are sleeping, and some people are working next to me. I get a call from a friend who I haven't talked to in a while and have had trouble setting up a time to chat with. What would you most likely do in this situation?",
        type: 'MULTIPLE',
        rank: 'positive',
        assignTo: { title: 'Adult' },
        subCompetency: { title: 'Appreciating Social & Environmental Diversity' },
    ...
    {
        question: 'I have heard from my co-workers that it is possible to exaggerate on our overtime to receive greater compensation since our supervisors do not check our timesheets. What would you most likely do in this situation?',
        type: 'MULTIPLE',
        rank: 'positive',
        assignTo: { title: 'Adult' },
        subCompetency: { title: 'Adaptive Behavior' },
    ...
    {
        question: 'On my commute back home from work on the train, I see a group of adults harassing another person on the train. There are many bystanders but everyone ignores what is happening to the victim. I am feeling uncomfortable with the situation.  What would you most likely do in this situation?',
        type: 'MULTIPLE',
        rank: 'positive',
        assignTo: { title: 'Adult' },
        subCompetency: { title: 'Adaptive Behavior' },
    ...
    {
        question: 'I was laid off and am having a difficult time paying my rent. I am in danger of being evicted. My family gives me a call, not knowing the situation.  What would you most likely do in this situation?',
        type: 'MULTIPLE',
        rank: 'positive',
        assignTo: { title: 'Adult' },
    ...
    {
        question: 'I am moving to a new apartment, but I cannot afford to hire movers. I have some large furniture and several boxes, but I know I cannot move everything on my own. My friends have offered to help. What would you most likely do in this situation?',
        type: 'MULTIPLE',
        rank: 'positive',
        assignTo: { title: 'Adult' },
        subCompetency: { title: 'Resource & Support Recognition' },
    ...
    {
        question: 'I notice a person at the park that appears to be exhibiting extreme emotional and mental distress.What would you most likely do in this situation?',
        type: 'MULTIPLE',
        rank: 'positive',
        assignTo: { title: 'Adult' },
        subCompetency: { title: 'Resource & Support Recognition' },
    ...
    {
        question: 'I feel disrespected often, and as a result, I have a difficult time showing respect for others.',
        type: 'RANGE',
        rank: 'negative',
        assignTo: { title: 'Adult' },
        subCompetency: { title: 'Resource & Support Recognition' },

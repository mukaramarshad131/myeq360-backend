  ...
  return (
    ...
    >
      <Col span={24} md={12} xl={16} className="flex-1 text-center md:text-left">
        ...
        >
          Welcome to join our free trial of the EQ360 Emotional Intelligence Assessment! Discover
          your emotional strengths and motivations, and understand your behaviors better. Thrive in
          personal and professional relationships with our comprehensive evaluation.
          <div>
            <a
              href="https://blog.slashspaces.com"
              target="_blank"
              className="mt-5 text-base font-bold opacity-80"
              style={{ color: themeToken.colorPrimaryTextActive }}
              rel="noreferrer"
            >
              👉 Free Individual trail Assessment test Link
            </a>
          </div>
        </div>
        <button
